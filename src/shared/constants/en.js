const LANG = {
  ...
  LEGEND_LOW_AVG_WB: ' ',
  LEGEND_HIGH_AVG_WB:
    'Larger gap (White students score higher) ▶',
  LEGEND_LOW_AVG_WH: ' ',
  LEGEND_HIGH_AVG_WH:
    'Larger gap (White students score higher) ▶',
  LEGEND_LOW_AVG_PN: ' ',
  LEGEND_HIGH_AVG_PN:
    'Larger gap (non-poor students score higher) ▶',
  LEGEND_LOW_AVG_MF: ' ',
  LEGEND_HIGH_AVG_MF:
    'Larger gap (male students score higher) ▶',
  ...
  LEGEND_LOW_GRD_PN: ' ',
  LEGEND_HIGH_GRD_PN:
    'Larger gap (non-poor students learn more) ▶',
  LEGEND_LOW_GRD_MF: ' ',
  ...
  LEGEND_LOW_SES_WB: ' ',
  LEGEND_HIGH_SES_WB:
    'Larger SES gap, favoring White families ▶',
  LEGEND_LOW_SES_WH: ' ',
  LEGEND_HIGH_SES_WH:
    'Larger SES gap, favoring White families ▶',
  ...
  LEGEND_LOW_SEG_WB: ' ',
  LEGEND_HIGH_SEG_WB:
    'More Racial-Economic School Segregation ▶',
  LEGEND_LOW_SEG_WH: ' ',
  LEGEND_HIGH_SEG_WH:
    'More Racial-Economic School Segregation ▶',
  LEGEND_LOW_SEG: ' ',
