const LANG = {
  ...
  "COMPARE_HINT_SES": "average SES in the community, not specific to any group",
  ...
  "FILTER_LABEL_SES_DESC": "ses",
  "FILTER_LABEL_SIZE": "Show Largest",
  "FILTER_LABEL_SIZE_DESC": "Of the 50 states, DC, and Puerto Rico",
  ...
  "HINT_SEG": "The gap in school poverty is a measure of school segregation. We use the proportion of students defined as \\economically disadvantaged\\\" in a school as a measure of school poverty. The gap in school poverty measures the difference of average poverty rates between two subgroups. When there is no segregation or when schools have equal poverty rates the school poverty gap is 0. A gap in school poverty means that one subgroups' schools have higher poverty rates than the other on average.",
  ...
  "LOCATIONS_ACTIVE_NONE": "You have not selected any schools, districts, counties, or states. Use the search bar above or select place in the map or chart view.",
  ...
  "MENU_FAQ": "FAQ",
  "MENU_HOME": "Home",
  "MENU_WHATS_NEW": "What's New in 4.0",
  ...
  "PANEL_DESCRIPTION_GAPS": "Gaps show the difference in educational opportunity between two subgroups by subtracting one subgroup’s values from the other. The further a gap value is from 0, the larger the imbalance between the two subgroups.",
  "PANEL_DESCRIPTION_LOCATIONS": "Locations that you have previously selected show up here. Select states, counties, districts, and schools using the map, chart, or search bar.",
  "PANEL_DESCRIPTION_METRICS": "The educational opportunity metrics above are based on math and ELA test scores for students in grades 3-8 for the years 2009-2018.",
