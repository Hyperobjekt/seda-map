const LANG = {
  ...
  UI_REPORT_LOADING:
    'Generating PDF report. Please be patientâ€”this may take up to 30 seconds...',
  ...
  LABEL_STUDENTS_ALL: 'Overall Average',
  ...
  LOCATIONS_ACTIVE_NONE:
    'You have not selected any schools, districts, counties, or states.',
  ...
  VALUE_AVG_GAP:
    '$[demographic1] and $[demographic2] studentsâ€™ average scores differ by $[value] grade levels.',
  VALUE_GRD_GAP:
    '$[demographic1] and $[demographic2] studentsâ€™ learning rates differ by $[value] per year.',
  VALUE_COH_GAP:
    '$[demographic1] and $[demographic2] studentsâ€™ test score trends differ by $[value] grade levels per year.',
  VALUE_SES_GAP:
    '$[demographic1] studentsâ€™ average socioeconomic status is $[difference] $[demographic2] studentsâ€™.',
  VALUE_SEG_GAP:
    'The poverty rate in $[demographic2] studentsâ€™ schools is $[value] $[highLow] than in $[demographic1] studentsâ€™ schools.',
  VALUE_MIN_GAP:
    'The percent of minority students in $[demographic2] studentsâ€™ schools is $[value] $[highLow] than in $[demographic1] studentsâ€™ schools.',
  ...
  HELP_MAP_COH_OVERVIEW:
    'Average student test scores are influenced by childrenâ€™s home environments, early childhood experiences, community resources, and schools. The trend (or change) in average student test scores from one year to the next indicates whether educational opportunities are improving or declining in a community.',
  HELP_CHART: 'What Does the Chart Show?',
  HELP_CHART_DOTS:
    'Each circle represents a $[region]. The circleâ€™s size shows the number of $[demographic] students.',
  HELP_CHART_Y:
    'This chart of $[region] in $[state] shows, on the vertical (Y) axis, $[metric] for $[demographic] on a scale $[metricDescription].',
  HELP_CHART_X_SES:
    'The horizontal (X) axis shows the $[region]â€™s socioeconomic status (SES), which is a broad measure of the economic and social resources available in a community.',
  HELP_CHART_X_FRL:
  ...
  HELP_CHART_PRIMARY:
    'The primary chart shows a comparison of $[demographic1] and $[demographic2] studentsâ€™ $[metric]. Each circle represents a $[region] in $[state]. The circleâ€™s size shows the number of students. The vertical (Y) axis shows $[metricRange] for $[demographic2] students, on a scale $[metricDescription]. The horizontal (X) axis shows the same for $[demographic1] students.',
  HELP_CHART_SECONDARY:
    'The chart on the right shows the $[gap] in $[metric] on the vertical (Y) axis. The higher up the axis, the larger the gap. The horizontal (X) axis shows the gap in $[secondary] between these two groups. The farther to the right, the larger the gap favors $[demographic1] families. Each circle represents a $[region] in $[state]. The circleâ€™s size shows the number of students.',
  HELP_DATA_OVERVIEW:
  ...
  HELP_GRD_CONCEPT:
    'Why Do Average Learning Rates Largely Reflect a Schoolâ€™s Effectiveness?',
  HELP_COH_CONCEPT:
  ...
  HELP_AVG_CONCEPT_A:
    'Average student test scores are influenced by opportunities to learn at home, in neighborhoods, in child-care, preschool, and after-school programs, from peers and friends, and in schools. Because of all these influences, average test scores are not a good way to assess how much children learn in schools. But they are a good way to assess the average set of educational opportunities available to children in a community. Where average scores are low, students have fewer opportunities to learn. Schools are better evaluated using learning rates, which measure how much studentsâ€™ scores improve while they are in school.',
  HELP_GRD_CONCEPT_A:
    'Learning rates measure how much studentsâ€™ scores improve each year while they are in school. This is a better way to assess what children learn in schools than average test scores, which are heavily influenced by factors outside of school. To understand the distinction, think of a hospital: We wouldnâ€™t assess a hospital based on the health of its patients; rather, weâ€™d judge it on how much the health of patients improves as a result of their time in the hospital. Similarly, we shouldnâ€™t evaluate a school based on the average scores of its students, but rather by how much their scores improve while in school.',
  HELP_COH_CONCEPT_A:
    'Average student test scores are influenced by home environments, early childhood experiences, community resources, and schools. The trend (or change) in average student test scores from one year to the next indicates whether educational opportunities are improving or declining in a community. Where the trend is positive, studentsâ€™ opportunities to learn are improving. Opportunities may improve over time because of changes in school quality or because of changes in family resources, home environments, early childhood experiences, and/or community resources.',
  HELP_AVG_A:
    'The average test score is based on the average of standardized math and English Language Arts (ELA) tests taken by public-school students in grades 3 through 8 between 2009 and 2016. See the <a href="/help-faq/#how-measures-computed" target="_blank">FAQ</a> for more detail.',
  HELP_GRD_A:
    'The learning rate is based on changes in average test scores from each year and grade to the next year and grade (e.g. changes from 2015 3rd-grade scores to 2016 4th-grade scores). The learning rates are calculated using standardized math and English Language Arts (ELA) tests taken by public school students in grades 3 through 8 between 2009 and 2016. See the <a href="/help-faq/#how-measures-computed" target="_blank">FAQ</a> for more detail.',
  HELP_COH_A:
    'The trend in test scores is based on changes in average test scores from each year to the next in the same grade (e.g. changes from 2015 3rd-grade scores to 2016 3rd-grade scores). The test-score trends are calculated using standardized math and English Language Arts (ELA) tests taken by public-school students in grades 3 through 8 between 2009 and 2016. See the <a href="/help-faq/#how-measures-computed" target="_blank">FAQ</a> for more detail.',
  HELP_SES_A:
    'Socioeconomic status (SES) is a broad measure of the economic and social resources available in a community. It is based on information about the income, educational attainment, employment, and structure of all families living in the community served by a school district or county. This information is combined into a single composite rating for each community. A rating of 0 represents the national average of socioeconomic status; higher ratings represent more affluent communities. See the <a href="/help-faq/#ses-measured" target="_blank">FAQ</a> for more detail.',
  HELP_SEG_A:
    'The gap in school poverty is a measure of school segregation. We use the proportion of students defined as â€œeconomically disadvantagedâ€ in a school as a measure of school poverty. The black-white gap in school poverty, for example, measures the difference between the poverty rate of the average black studentâ€™s school and the poverty rate of the average white studentâ€™s school. When there is no segregationâ€”when white and black students attend the same schools, or when white and black studentsâ€™ schools have equal poverty ratesâ€”the black-white school poverty gap is 0. A positive black-white school poverty gap means that black studentsâ€™ schools have higher poverty rates than white studentsâ€™ schools, on average. A negative black-white school poverty gap means that white studentsâ€™ schools have higher poverty rates than black studentsâ€™ schools, on average.',
  HELP_FRL_A:
  ...
  HELP_MIN_A:
    'The gap in percent minority students in schools (shown in the secondary gap charts) is a measure of school segregation. Percent minority students in schools is measured as the proportion of minority students (black students plus Hispanic students) in a studentâ€™s school. The black-white gap in percent minority students in schools then measures the difference between the proportion of minority students in the average black studentâ€™s school and the proportion of minority students in the average white studentâ€™s school. When there is no segregationâ€”when white and black students attend the same schools, or when white and black studentsâ€™ schools have equal proportions of minority studentsâ€”the black-white gap in percent minority students is 0. A positive black-white gap in percent minority students means that black studentsâ€™ schools have higher shares of minority students than white studentsâ€™ schools, on average. A negative black-white gap in percent minority students means that white studentsâ€™ schools have higher shares of minority students than black studentsâ€™ schools, on average.',
  HELP_HOW_Q1:
  ...
  HELP_HOW_Q1_A:
    'The Educational Opportunity Explorer offers three different ways of looking at educational opportunity in the U.S.: a map, a chart, and a â€œsplit screenâ€ view of both. Use the <strong>Map | Chart | Map + Chart</strong> buttons in the tool to select one of these views.',
  HELP_HOW_Q2_A:
    '<p>At the top of this Explorer, you can select from <strong>3 Key Measures</strong> of educational opportunity to display in the map and chart:</p>\n<ul>\n  <li>Average test scores, which reflect educational opportunities in and out of school</li>\n  <li>Learning rates, which reflect school effectiveness</li>\n  <li>Trends in test scores, which reflect changes in educational opportunity</li>\n</ul>\n<p>Just below these buttons, you can use the <strong>â€œShowing â€¦â€</strong> drop-down menus to filter by demographic (e.g. â€œall studentsâ€ or â€œfemale studentsâ€) or the gap between demographics (e.g. â€œmale-female gapâ€), and the type of places (counties, school districts, or schools) youâ€™d like to display. In the Chart view, you can choose to view data for the entire country , or individual U.S. states.</p>',
  HELP_HOW_Q3_A:
    '<p>Light gray represents the national average, or â€œno changeâ€ (for trends in test scores).</p>\n<p>The deeper the green, the farther above the national averageâ€”or, for trends in test scores, the greater the improvement in scores over time.</p>\n<p>The deeper the blue, the farther below the national averageâ€”or for trends in test scores, the greater the decline in scores over time.</p>\n<p><i>Colorblind users: We have made efforts to ensure accessibility for the most common forms of colorblindness. For less common forms (such as tritanopia), colors may be less distinguishable; however, the data are still accessible in the map legend, charts, and other displays.</i></p>',
  HELP_HOW_Q4_A:
    'You can view data for counties, school districts, and public schools. To change between location types, use the <strong>â€œShowing â€¦â€</strong> menu in the top left of the header.',
  HELP_HOW_Q5_A:
    '<p>You can navigate to your desired location via the navigation controls in the map. Or type a location name into the search bar in the upper right corner of the map and chart.</p>\n<p>Hovering (or on a touch device, tapping) on a location in the map or chart will show an overview of that locationâ€™s data. Clicking or tapping on the location will open a <strong>Location Panel</strong> that shows a full view of all available data, as well as options for viewing other selected locations. You can also export a <strong>PDF report</strong> from this panel.</p>\n<p>Clicking or tapping on locations will also add them as tabs in the bottom of the screen. (You can add up to six locations.) Click or tap on any locationâ€™s tab to highlight it in the map or chart, and the Location Panel.</p>',
  HELP_HOW_Q6_A:
    'You can display a set of up to six location tabs at once. Each additional selection will remove a selection from the beginning of the set.',
  HELP_HOW_Q7_A:
    'Clicking or tapping on any location will open a <strong>Location Panel</strong> that offers a full view of the data.',
  HELP_HOW_Q8_A:
    '<p>In two ways. First, you can select up to six locations and view all their data together in the â€œComparisonâ€ tab of the <strong>Location Panel</strong> (which opens when you click on a place in the map or on the chart).</p>\n<p>Below your selected locations in the Comparison tab, you can choose <strong>Show Similar Places</strong> to display additional locations that are similar to the most-recently-selected-place.</p>',
  HELP_HOW_Q9_A:
    '<p>For each Key Measure (such as average test scores), we offer data on the gaps between certain demographic groups, such as White / Black, Male / Female, and Poor / Non-Poor.</p>\n<p>You can view these gaps in the map and chart by selecting groups for comparison in the <strong>â€œShowing â€¦â€</strong> menu in the header, or in the <strong>Location Panel</strong> that opens when clicking / tapping on a location.</p>\n<p>In Map View, the size of the gap is shown as colors on the map.</p>\n<p>In Chart View, the demographic groups are charted on the horizontal and vertical axes, and the distance from the diagonal line in the chart shows the size of the gap.</p>\n<p>While in Chart View, you can also select <strong>Show Gap vs. Other Metrics</strong> to view a second chart. Here, the size of the gap is plotted on the vertical axis. The gap between groups on another measure (such as socioeconomic status) is shown on the horizontal axis.</p>',
  HELP_HOW_Q10_A:
  ...
  PANEL_DESCRIPTION_METRICS:
    'The educational opportunity metrics above are based on test scores for students in grades 3 - 8 for the years 2009 - 2018.',
  PANEL_DESCRIPTION_SUBGROUPS:
    'Subgroups and gaps are not available when viewing school level data.  Switch to state, county, or districts to view subgroup data.',
  PANEL_DESCRIPTION_GAPS:
    "Gaps show the difference between two subgroup's educational opportunity by subtracting one subgroups values from another.  The further a gap value is from 0, the larger the imbalance between the two subgroups.",
  PANEL_DESCRIPTION_LOCATIONS:
    'Locations that you have previously selected show up here.  Select states, counties, districts, and schools using the map, chart, or search.',
  ...
  LOAD_SIMILAR_HINT:
    'Load the 5 most similar places to $[location], based on demographics and socioeconomic conditions.',
  LOCATIONS_SEARCH: 'Find a place',
  COMPARE_HINT_AVG: 'grade levels relative to national average',
  COMPARE_HINT_GRD:
    '% learned each grade, relative to national average',
