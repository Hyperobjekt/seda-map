const LANG = {
  ...
  "FOOTNOTE_CHART_FILTER": "$[largest] $[region] in $[parentLocation] are highlighted.",
  "FOOTNOTE_CHART_GAP": "$[region] above or to the right of the \"no gap\" line have a gap favoring $[yDem].",
  "FOOTNOTE_CHART_SIZE": "Circle size reflects number of students.",
  "FOOTNOTE_CHART_VS": "Dotted line indicates no gap ($[yDem] = $[xDem]).",
  "FOOTNOTE_CHART_VS2": "$[region] above dotted line indicate a gap favoring $[yDem] students.",
  ...
  "HELP_CHART_DOTS": "Each circle represents a $[region]. The circleâ€™s size shows the number of $[demographic] students.",
  "HELP_CHART_PRIMARY": "The primary chart shows a comparison of $[demographic1] and $[demographic2] studentsâ€™ $[metric]. Each circle represents a $[region] in $[state]. The circleâ€™s size shows the number of students. The vertical (Y) axis shows $[metricRange] for $[demographic2] students, on a scale $[metricDescription]. The horizontal (X) axis shows the same for $[demographic1] students.",
  ...
  "HELP_CHART_X_SES": "The horizontal (X) axis shows the $[region]â€™s socioeconomic status (SES), which is a broad measure of the economic and social resources available in a community.",
  ...
  "HELP_HOW_Q8_A": "<p>In two ways. First, you can select up to six locations and view all their data together in the â€œComparisonâ€ tab of the <strong>Location Panel</strong> (which opens when you click on a place in the map or on the chart).</p>\n<p>Below your selected locations in the Comparison tab, you can choose <strong>Show Similar Places</strong> to display additional locations that are similar to the most-recently-selected-place.</p>",
  ...
  "HINT_AVG": "How students score, in grade levels, relative to the national average for grades 3 - 8",
  "HINT_COH": "An average of how students' test scores change in grade levels per year, for grades 3 - 8 from 2009 - 2016",
  "HINT_GAP_AVG": "",
  "HINT_GAP_COH": "",
  "HINT_GAPGRD": "",
  "HINT_GRD": "An average of how much students' test scores improve per year, relative to the national average, as they progress through grades 3 - 8",
  "HP_CHART": "chart",
  "HP_MAP": "map",
  ...
  "UI_REPORT_LOADING": "Generating PDF report. Please be patientâ€”this may take up to 30 seconds...",
  "UI_SPLIT_BUTTON": "Chart + map",
  "UI_SPLIT_BUTTON_SR": "Go to chart and map split view",
  "VALUE_AVG_GAP": "$[demographic1] and $[demographic2] studentsâ€™ average scores differ by $[value] grade levels.",
  ...
  "VALUE_COH_GAP": "$[demographic1] and $[demographic2] studentsâ€™ test score trends differ by $[value] grade levels per year.",
  ...
  "VALUE_GRD_GAP": "$[demographic1] and $[demographic2] studentsâ€™ learning rates differ by $[value] per year.",
  ...
  "VALUE_MIN_GAP": "The percent of minority students in $[demographic2] studentsâ€™ schools is $[value] $[highLow] than in $[demographic1] studentsâ€™ schools.",
  "VALUE_SEG": "<strong>$[value] school poverty</strong>",
  "VALUE_SEG_GAP": "The poverty rate in $[demographic2] studentsâ€™ schools is $[value] $[highLow] than in $[demographic1] studentsâ€™ schools.",
  "VALUE_SES_GAP": "$[demographic1] studentsâ€™ average socioeconomic status is $[difference] $[demographic2] studentsâ€™.",
