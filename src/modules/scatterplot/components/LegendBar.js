...
const getGradient = ({
  ...
  const colorStartPercent =
    (100 * (colorRange[0] - legendRange[0])) /
...
const LegendBar = ({
  ...
  return (
    <div
      ...
      {title && <div className="legend-bar__title">{title}</div>}
      {startLabel && endLabel && (
      ...
      <div className="legend-bar__values">
        ...
        <div
          className="legend-bar__value legend-bar__value--zero"
          style={{
            position: 'absolute',
      ...
      <div
        ...
        <div
          className={classNames('legend-bar__marker', {
        ...
        <div
          ...
          <span className="legend-bar__arrow" />
        </div>
      </div>
    </div>
  )
